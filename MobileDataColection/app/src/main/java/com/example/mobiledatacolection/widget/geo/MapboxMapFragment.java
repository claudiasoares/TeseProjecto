...
public class MapboxMapFragment extends com.example.mobiledatacolection.widget.geo.mapboxsdk.MapFragment
    ...
    private void addMbtiles(String id, File file) {
        ...
        if (mbtiles.getLayerType() == MbtilesFile.LayerType.VECTOR) {
        ...
        if (mbtiles.getLayerType() == MbtilesFile.LayerType.RASTER) {
