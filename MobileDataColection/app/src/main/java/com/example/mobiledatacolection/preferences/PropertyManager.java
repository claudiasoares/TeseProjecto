...
import static com.example.mobiledatacolection.preferences.GeneralKeys.KEY_METADATA_EMAIL;
import static com.example.mobiledatacolection.preferences.GeneralKeys.KEY_METADATA_PHONENUMBER;
import static com.example.mobiledatacolection.preferences.GeneralKeys.KEY_METADATA_USERNAME;
import static com.example.mobiledatacolection.utils.PermissionUtils.isReadPhoneStatePermissionGranted;
...
public class PropertyManager implements IPropertyManager {
    ...
    public PropertyManager(Context context) {
        ...
        MobileDataCollect.getInstance().getComponent().inject(this);
        try {
    ...
    public String getSingularProperty(String propertyName) {
        if (!isReadPhoneStatePermissionGranted(MobileDataCollect.getInstance()) && isPropertyDangerous(propertyName)) {
