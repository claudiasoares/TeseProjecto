package com.example.mobiledatacolection.Events;

import androidx.annotation.NonNull;

import com.example.mobiledatacolection.Preferences.ReadPhoneStatePermissionRxEvent;
...
public class RxEventBus {
     ...
     */
    public void post(@NonNull ReadPhoneStatePermissionRxEvent event) {
