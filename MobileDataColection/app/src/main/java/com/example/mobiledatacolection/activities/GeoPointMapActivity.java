...
import com.example.mobiledatacolection.activities.BaseGeoMapActivity;
...
import com.example.mobiledatacolection.widget.geo.MapPoint;
import com.example.mobiledatacolection.widget.geo.MapProvider;
...
import static com.example.mobiledatacolection.widget.GeopointWidget.DRAGGABLE_ONLY;
import static com.example.mobiledatacolection.widget.GeopointWidget.LOCATION;
import static com.example.mobiledatacolection.widget.GeopointWidget.READ_ONLY;
...
public class GeoPointMapActivity extends BaseGeoMapActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(getBaseContext(),R.string.google_play_services_error_occured,Toast.LENGTH_SHORT);
            finish();
            return;
        }
    ...
    public void returnLocation() {
        ...
        if (result != null) {
            setResult(RESULT_OK, new Intent().putExtra("LOCATION_RESULT", result));
        }
        finish();
    }
    ...
    public void initMap(MapFragment newMapFragment) {
        ...
        // Menu Layer Toggle
        findViewById(R.id.layer_menu).setOnClickListener(new View.OnClickListener() {
            @Override
