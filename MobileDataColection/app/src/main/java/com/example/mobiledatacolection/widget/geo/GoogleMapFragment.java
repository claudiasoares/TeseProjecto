...
import com.example.mobiledatacolection.adapters.LocationClient.LocationClientListener;
...
import com.example.mobiledatacolection.utils.GeoUtils;
...
import static com.example.mobiledatacolection.widget.geo.MapFragment.BOTTOM;
import static com.example.mobiledatacolection.widget.geo.MapFragment.CENTER;
import static com.example.mobiledatacolection.widget.geo.MapFragment.INITIAL_CENTER;
import static com.example.mobiledatacolection.widget.geo.MapFragment.INITIAL_ZOOM;
import static com.example.mobiledatacolection.widget.geo.MapFragment.POINT_ZOOM;


public class GoogleMapFragment extends SupportMapFragment implements
         LocationListener, LocationClientListener,
        OnMapClickListener, OnMapLongClickListener,
        OnMarkerClickListener, OnMarkerDragListener,
        OnPolylineClickListener, com.example.mobiledatacolection.widget.geo.MapFragment {
    ...
    @Override public void addTo(
        ...
        getMapAsync((GoogleMap map) -> {
            if (map == null) {
                Toast.makeText(activity.getBaseContext(),R.string.google_play_services_error_occured,Toast.LENGTH_SHORT);
