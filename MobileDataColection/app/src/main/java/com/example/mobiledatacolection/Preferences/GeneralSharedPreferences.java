...
import static com.example.mobiledatacolection.Preferences.GeneralKeys.GENERAL_KEYS;
...
public class GeneralSharedPreferences {
    ...
    private GeneralSharedPreferences() {
        sharedPreferences = PreferenceManager.getDefaultSharedPreferences(MobileDataCollect.getInstance());
    }
    ...
    public void reloadPreferences() {
        for (Map.Entry<String, Object> keyValuePair : GENERAL_KEYS.entrySet()) {
