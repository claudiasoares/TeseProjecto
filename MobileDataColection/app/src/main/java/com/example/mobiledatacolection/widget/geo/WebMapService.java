...
import com.example.mobiledatacolection.widget.utils.TranslationHandler;
...
public class WebMapService implements Serializable {
    ...
    @Deprecated
    public WebMapService(int cacheNameStringId, int minZoomLevel,
                         int maxZoomLevel, int tileSize, String copyright, String... urlTemplates) {
        this(TranslationHandler.getString(MobileDataCollect.getInstance(), cacheNameStringId),
