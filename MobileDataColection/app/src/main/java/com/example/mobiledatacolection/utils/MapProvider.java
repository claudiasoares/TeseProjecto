...
import com.example.mobiledatacolection.widget.geo.MapboxMapConfigurator;
import com.example.mobiledatacolection.widget.geo.OsmDroidMapConfigurator;
import com.example.mobiledatacolection.widget.geo.WebMapService;
import com.mapbox.mapboxsdk.maps.Style;
import com.example.mobiledatacolection.R;
import com.example.mobiledatacolection.fragmentos.widget.MapFragment;
import com.example.mobiledatacolection.widget.utils.GoogleMapConfigurator;
...
import static com.example.mobiledatacolection.preferences.GeneralKeys.BASEMAP_SOURCE_CARTO;
import static com.example.mobiledatacolection.preferences.GeneralKeys.BASEMAP_SOURCE_GOOGLE;
import static com.example.mobiledatacolection.preferences.GeneralKeys.BASEMAP_SOURCE_MAPBOX;
import static com.example.mobiledatacolection.preferences.GeneralKeys.BASEMAP_SOURCE_OSM;
import static com.example.mobiledatacolection.preferences.GeneralKeys.BASEMAP_SOURCE_STAMEN;
import static com.example.mobiledatacolection.preferences.GeneralKeys.BASEMAP_SOURCE_USGS;
import static com.example.mobiledatacolection.preferences.GeneralKeys.KEY_CARTO_MAP_STYLE;
import static com.example.mobiledatacolection.preferences.GeneralKeys.KEY_GOOGLE_MAP_STYLE;
import static com.example.mobiledatacolection.preferences.GeneralKeys.KEY_MAPBOX_MAP_STYLE;
import static com.example.mobiledatacolection.preferences.GeneralKeys.KEY_USGS_MAP_STYLE;
...
public class MapProvider {
    ...
    private static SourceOption[] initOptions() {
        SourceOption[] sourceOptions = new SourceOption[]{
                new SourceOption(BASEMAP_SOURCE_GOOGLE, R.string.basemap_source_google,
                        new GoogleMapConfigurator(
                                ...
                                new com.example.mobiledatacolection.widget.geo.GoogleMapConfigurator.GoogleMapTypeOption(GoogleMap.MAP_TYPE_NORMAL, R.string.streets),
                                new com.example.mobiledatacolection.widget.geo.GoogleMapConfigurator.GoogleMapTypeOption(GoogleMap.MAP_TYPE_TERRAIN, R.string.terrain),
                                new com.example.mobiledatacolection.widget.geo.GoogleMapConfigurator.GoogleMapTypeOption(GoogleMap.MAP_TYPE_HYBRID, R.string.hybrid),
                                new com.example.mobiledatacolection.widget.geo.GoogleMapConfigurator.GoogleMapTypeOption(GoogleMap.MAP_TYPE_SATELLITE, R.string.satellite)
                        )
                ),
                ...
                new SourceOption(BASEMAP_SOURCE_OSM, R.string.basemap_source_osm, new MapConfigurator() {
                    @Override
                    ...
                    @Nullable
                    @Override
                    public com.example.mobiledatacolection.widget.geo.MapFragment createMapFragment(Context context) {
                        return null;
                    }
    ...
    public MapFragment createMapFragment(Context context) {
        ...
        MapFragment map = (MapFragment) cftor.createMapFragment(context);
        if (map != null) {
    ...
    public void onMapFragmentStart(MapFragment map) {
    ...
    public void onMapFragmentStop(MapFragment map) {
