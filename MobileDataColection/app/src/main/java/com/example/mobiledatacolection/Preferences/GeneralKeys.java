...
public final class GeneralKeys {
    ...
    private static HashMap<String, Object> getHashMap() {
        ...
        // aggregate_preferences.xml
        hashMap.put(KEY_SERVER_URL,                 MobileDataCollect.getInstance().getString(R.string.default_server_url));
        ...
        // other_preferences.xml
        hashMap.put(KEY_FORMLIST_URL,               MobileDataCollect.getInstance().getString(R.string.default_odk_formlist));
        hashMap.put(KEY_SUBMISSION_URL,             MobileDataCollect.getInstance().getString(R.string.default_odk_submission));
        // server_preferences.xml
        hashMap.put(KEY_PROTOCOL,                   MobileDataCollect.getInstance().getString(R.string.protocol_odk_default));
        hashMap.put(KEY_SMS_GATEWAY,                "");
        hashMap.put(KEY_SUBMISSION_TRANSPORT_TYPE,  MobileDataCollect.getInstance().getString(R.string.transport_type_value_internet));
        // user_interface_preferences.xml
        hashMap.put(KEY_APP_THEME,                  MobileDataCollect.getInstance().getString(R.string.app_theme_light));
        hashMap.put(KEY_APP_LANGUAGE,               "");
        hashMap.put(KEY_FONT_SIZE,                  MobileDataCollect.DEFAULT_FONTSIZE);
        hashMap.put(KEY_NAVIGATION,                 NAVIGATION_SWIPE);
        hashMap.put(KEY_SHOW_SPLASH,                false);
        hashMap.put(KEY_SPLASH_PATH,                MobileDataCollect.getInstance().getString(R.string.default_splash_path));
        // map_preferences.xml
